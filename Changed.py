'''reate a class MyStatisticalList which inherits list class
This class has following method -> add_element - this methods add element to list but it also verify that element is a number otherwise it should raise error.
Then Add your all statistics methods in Day-21 to this class to directly call the mean, variance etc on this class.'''
